...
includeScript ('../../bundles/qwtaxi/booking/js/jquery-ui-1.10.3.custom.min.js');
includeScript ('../../bundles/qwtaxi/booking/js/jquery.fancyform.js');
includeScript ('../../bundles/qwtaxi/booking/js/jquery.placeholder.js');
includeScript ('../../bundles/qwtaxi/booking/js/regula.js');
